		...
		<div class="col-md-12 wow fadeInUp" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	<li role="presentation" ><a href="<%=basePath %>ExpendType/frontlist">支出类型列表</a></li>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="expendTypeAdd"> 
						  ...
						  <div class="form-group">
						  	 ...
						  	 <div class="col-md-8">
							    <input type="text" id="expendType_expendTypeName" name="expendType.expendTypeName" class="form-control" placeholder="请输入支出类型名称">
							 </div>
						  </div>
				          <div class="form-group">
